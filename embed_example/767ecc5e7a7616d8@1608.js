...
md`## Pre-loaded Data`
  ...
  main.variable(observer("inputs_url")).define("inputs_url", function(){return(
'https://raw.githubusercontent.com/vizgen/data_for_observable/master/inputs.json.zip'
)});
  main.variable(observer("inputs")).define("inputs", ["inputs_url","jszip"], function(inputs_url,jszip){return(
fetch(inputs_url)
...
'https://raw.githubusercontent.com/vizgen/data_for_observable/master/meta_gene.csv'
)});
...
'https://raw.githubusercontent.com/vizgen/data_for_observable/master/per-gene-counts_slice-1_replicate-2_zip/' + select_meta + '.csv.zip'
)});
  main.variable(observer("gene_data")).define("gene_data", ["select_meta","load_zip_csv","zip_gene_data_url"], function(select_meta,load_zip_csv,zip_gene_data_url)
{
  var gene_data
