...
require("jszip@3/dist/jszip.min.js")
  ...
  main.variable(observer()).define(["load_zip_json"], function(load_zip_json){return(
load_zip_json('https://raw.githubusercontent.com/cornhundred/testing_something/master/inputs.json.zip')
)});
  main.variable(observer()).define(["zip_inputs"], function(zip_inputs){return(
zip_inputs
)});
  main.variable(observer("zip_inputs")).define("zip_inputs", ["jszip"], function(jszip){return(
fetch('https://raw.githubusercontent.com/cornhundred/testing_something/master/inputs.json.zip')
  ...
  main.variable(observer()).define(["json_as_csv"], function(json_as_csv){return(
json_as_csv['columns']
)});
  main.variable(observer()).define(["d3"], function(d3){return(
d3
)});
  main.variable(observer("load_zip_json")).define("load_zip_json", ["jszip","d3"], function(jszip,d3){return(
function load_zip_json(url) {
  ...
  main.variable(observer()).define(["tmp"], function(tmp){return(
tmp
)});
  main.variable(observer("JSZip")).define("JSZip", ["require"], function(require){return(
require('https://bundle.run/jszip@3.1.5')
)});
  return main;
}
